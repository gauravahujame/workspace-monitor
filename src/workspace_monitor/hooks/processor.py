...
class HookProcessor:
    ...
    def _get_project_path(self, file_path: str = None, cwd: str = None) -> Path:
        """Determine project path from file path or working directory."""
        path = file_path or cwd or os.getcwd()
    ...
    def _extract_project_from_response(self, response: str) -> Path:
    ...
    def _parse_git_command(self, command: str) -> str:
